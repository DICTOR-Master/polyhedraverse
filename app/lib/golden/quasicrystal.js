...
// Copied from Rhombiverse (src/geometry-extensions/quasicrystal.js, the
// 5D/6D cut-and-project engine) for the golden-rhombohedra helper; the two
// constants it took from Rhombiverse's growth.js are inlined below.
const PHI = (1 + Math.sqrt(5)) / 2;
const STAR_DIRECTIONS = buildStarDirections();
