...
export const CHANGELOG: ChangelogDay[] = [
  {
    ...
    entries: [
      ...
      'The tetrahedron now unlocks its extra real 4D closures in RCP-C2B — the 5-cell and the 600-cell, alongside the already-known 16-cell — picked from a small menu when you start building. The 600-cell\'s own reference cell is honestly, unavoidably non-regular (every dual cell of the 120-cell is equally so, a real consequence of its symmetry, not a rendering flaw) and is shown as such rather than forced into a fake regular shape.',
