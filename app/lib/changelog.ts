...
export const CHANGELOG: ChangelogDay[] = [
  {
    ...
    entries: [
      ...
      'Added a "Coordinates" overlay to RCP-C2B: reveals each built cell\'s own real generating coordinate as a purple point, joined to the shape\'s center by a line — the literal point the underlying 4D construction generates that cell from, made visible for the first time. On the 600-cell, a second color also marks its dual points: each of its tetrahedra\'s corners is the true center of a dodecahedral cell from the original 120-cell it was built from, and now you can see exactly where.',
