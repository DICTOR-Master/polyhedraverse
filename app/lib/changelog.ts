...
export const CHANGELOG: ChangelogDay[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      'Added a one-click Open / Closed view toggle to RCP-C2B: switch every cell you\'ve placed between an ordinary undistorted copy of the seed shape and its real, warped position inside the closed 4-polytope — watch the actual difference between a 3-dimensional and a 4-dimensional object change in front of you. The chosen view is saved with the rest of your scene.',
      ...
      'Added an "RCP-Coordinates" overlay to RCP-C2B: reveals each built cell\'s own real generating coordinate, marked with a small cross (like a point on an architect\'s drawing) and joined to the shape\'s center by a purple laser beam — the literal point the underlying 4D construction generates that cell from. On the 600-cell, a second color also marks its dual points: each of its tetrahedra\'s corners is the true center of a dodecahedral cell from the original 120-cell it was built from, and now you can see exactly where.',
  ...
  },
  {
    date: '2026-09-08',
    entries: [
      'The project is now Polyhedraverse, with its own logo and branding.',
